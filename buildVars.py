...
addon_info = {
	...
	"addon_version": "1.1",
	# Author(s)
	"addon_author": "Ángel Reyes <angeldelosreyesfaz@gmail.com>, Marco leija <marcomolinaleija@hotmail.com>",
...
pythonSources = ["addon/globalPlugins/rutas_fav/__init__.py",
"addon/globalPlugins/rutas_fav/dialog.py",
